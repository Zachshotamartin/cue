export function normalizeRoute(href, base) {
  try {
    ...
    if (
      ...
      /\/(logout|signout|delete|remove|unsubscribe)(\/|$)/i.test(u.pathname)
    )
      return null;
